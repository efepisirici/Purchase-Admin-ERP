...
echo '<div id="FooterLogoDiv">';
	echo '<img src="'. $RootPath . '/' . $_SESSION['LogoFile'] . '" width="120" alt="Purchase Admin" title="Purchase Admin ' . _('Copyright') . ' &copy; purchaseadmin.com - ' . date('Y') . '" />';
echo '</div>';
...
echo '<div id="FooterVersionDiv">';
	echo 'Purchase Admin ' . _('version') . ' ' . $_SESSION['VersionNumber'] . ' ' . _('Copyright') . ' &copy; 2017 - ' . Date('Y'). ' <a target="_blank" href="http://purchaseadmin.com/">purchaseadmin.com</a>';
echo '</div>';
